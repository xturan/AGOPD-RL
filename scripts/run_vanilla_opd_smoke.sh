...
TENSORBOARD_DIR=${TENSORBOARD_DIR:-${PROJECT_DIR}/tensorboard/vanilla_opd_smoke}
...
"${OPD_PYTHON}" -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name=vanilla_opd_smoke \
  ...
  trainer.rollout_data_dir="${PROJECT_DIR}/outputs/vanilla_opd_smoke/rollouts" \
  "$@"

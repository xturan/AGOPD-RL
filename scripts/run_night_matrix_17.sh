#!/usr/bin/env bash
# 云端 1.7B 四方法整晚矩阵(200 步 each, seed 42, LoRA r16 lr1e-4)
# E1 Pure GRPO / E2 Pure OPD / E3 GRPO+OPD / AGOPD (hard CE + gate)
set -euo pipefail
...
# E1: Pure GRPO
run_one cloud_17_e1_puregrpo_200step "distillation.enabled=False"

# E2: Pure OPD (distillation only, no task rewards)
